...
export default function PlacesPage({ selected, onChange }) {
    ...
    function inputDescription(text) {
        return (
            <p className="text-grey-500 text-sm">{text}</p>
        );
    }
                ...
                <div className="">
                    <form>
                        ...
                        <div className="flex gap-2">
                            ...
                            <button onClick={addPhotoByLink} className="bg-gray-400 px-4 rounded-2xl">Add&nbsp Photo</button>
                        </div>
                        ...
                        {preInput('Description', 'description of th place')}
                        <textarea 
                        value={description} 
